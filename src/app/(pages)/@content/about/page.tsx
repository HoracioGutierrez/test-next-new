...
export default function AboutContent({ }: Props) {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <Collapse className="mb-6" accordion expandIcon={()=><DoubleArrowDownIcon />} destroyInactivePanel items={[
        {
          label: (
        ...
        },
        {
          ...
          children: (
            <div className="font-mono font-thin text-sm">
              <p className="mb-4">Ultimamente el desarrollo, especialmente el web, estuvo dando muchos giros 360 pero por algun motivo segui apostando al desarrollo reactivo, por no decir que decidi creer en React y Javascript y por suerte creo que decidi bien. En estos ultimos meces se anunciaron los ultimos avances de integracion para Front y Back con Next.js y es por eso que decidí finalmente tener un portfolio oficial y al mismo tiempo hacerlo con las últimas de las tecnologias. Paso a contrar.</p>
            </div>
          )
        },
        {
          ...
          children: (
            <div className="font-mono font-thin text-sm">
              <p className="mb-4">Esta pagina fue creada con el siguiente stack : </p>
        ...
        },
        {
          ...
          children: (
            <div className="font-mono font-thin text-sm">
              <p className="mb-4">Tambien, dentro del stack me decidí por integrar algun que otro nuevo feature de las ultimas versiones como por ejemplo : </p>
              <ul className="list-disc list-inside mb-4">
