  ...
  return (
    <>
      ...
      <section>
        ...
        <Link prefetch={false}  href="/stars/new" className="bg-slate-600 text-white p-2 mt-4 rounded block w-fit hover:bg-slate-700 hover:text-yellow-200 transition-colors">agregar estrella</Link>
      </section>
    </>
  )
}