  ...
  return (
    <>
      ...
      <section>
        ...
        <Link prefetch={false}  href="/stars/new" className="bg-transparent hover:text-yellow-200 ripple-bg-slate-600 border-slate-600 border-2 text-white p-2 mt-4 rounded block w-fit transition-colors btn">agregar estrella</Link>
      </section>
    </>
  )
}